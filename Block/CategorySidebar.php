...
namespace Kashyap\CategorySidebar\Block;
 ...
 * Kashyap\CategorySidebar\Block
 *
 * @author      Kashyap
 * @package     Kashyap\CategorySidebar
 * @copyright   Copyright (c) 2015, Kashyap. All rights reserved
 */
class CategorySidebar extends Template
{
    ...
    public function __construct(
		...
		\Kashyap\CategorySidebar\Helper\Data $dataHelper,
        $data = [ ]
    )
    {
